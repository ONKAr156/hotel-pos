            ...
            <div className="flex-1 bg-gray-100 dark:bg-gray-900 p-6 block md:flex  ">
                <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 flex-1 h-full ">
                    ...
                    <div className='md:hidden flex  gap-2  bg-slate-900 w-full  '>
                        <button
                            onClick={e => setToggle("Starters")}
                            className={` ${toggle === "Starters" ? "bg-blue-600" : "bg-slate-400 text-black"} text-white p-2 rounded-md `}>Starters</button>
                        <button
                            onClick={e => setToggle("Main-Course")}
                            className={` ${toggle === "Main-Course" ? "bg-blue-600" : "bg-slate-400 text-black"} text-white p-2 rounded-md `}>Main-Course</button>
                        <button
                            onClick={e => setToggle("Desserts")}
                            className={` ${toggle === "Desserts" ? "bg-blue-600" : "bg-slate-400 text-black"} text-white p-2 rounded-md `}>Desserts</button>
                        <button
                            onClick={e => setToggle("Beverages")}
                            className={` ${toggle === "Beverages" ? "bg-blue-600" : "bg-slate-400 text-black"} text-white p-2 rounded-md `}>Beverages</button>
